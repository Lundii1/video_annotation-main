...
actions = [
  ...
  { "id": 3, "name": "Lead Hook" },
  { "id": 4, "name": "Rear Hook" },
  { "id": 5, "name": "Lead Uppercut" },
  { "id": 6, "name": "Rear Uppercut" },
  { "id": 7, "name": "Rear Overhand" },
  { "id": 8, "name": "Body Shot" },
  { "id": 9, "name": "Slip" },
  { "id": 10, "name": "Bob and Weave" },
  { "id": 11, "name": "Pull" },
  { "id": 12, "name": "Duck" },
  { "id": 13, "name": "Parry" },
  { "id": 14, "name": "Block" },
  { "id": 15, "name": "Clinch" },
  { "id": 16, "name": "Pivot" },
  { "id": 17, "name": "Angle off" },
  { "id": 18, "name": "Punch Feint" },
  { "id": 19, "name": "Shoulder Feint" },
  { "id": 20, "name": "Feet / step feint" }
]
